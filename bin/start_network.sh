...
java -cp "lib/*" i5.las2peer.tools.L2pNodeLauncher -s service -p 9011 --node-id-seed 1 uploadStartupDirectory\(\'etc/startup\'\) startService\(\'i5.las2peer.services.threadedCommentService.ThreadedCommentService@0.2\'\) startService\(\'i5.las2peer.services.commentManagementService.CommentManagementService@0.2\'\) startWebConnector interactive
