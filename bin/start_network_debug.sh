...
java -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5432 -cp "lib/*" i5.las2peer.tools.L2pNodeLauncher -p 9011 uploadStartupDirectory\(\'etc/startup\'\) startService\(\'i5.las2peer.services.commentService.CommentService@0.1\',\'someNewPass\'\) startService\(\'i5.las2peer.services.commentExampleService.CommentExampleService@0.1\',\'someNewPass\'\) startWebConnector interactive
